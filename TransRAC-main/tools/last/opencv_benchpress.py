...
# --- 설정 ---
VIDEO_PATH = r"C:\mycla\TransRAC-main\RepCountA\video\train\stu8_2.mp4"  # 🎥 테스트할 영상 경로
EXERCISE = "benchpress"

# 벤치프레스 기준 각도 임계값 (Shoulder–Elbow–Wrist)
LOW_TH, HIGH_TH = 100, 115      # 바벨 내릴 때↓, 올릴 때↑
DEBOUNCE_FR = 2
TARGET_RANGE = 80.0
...
with mp_pose.Pose(model_complexity=2,
    ...
    while True:
        ...
        cv2.imshow("Bench Press Counter", cv2.resize(frame, (960, 720)))
